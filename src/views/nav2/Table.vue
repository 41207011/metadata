<template>
    <section>
        ...
        <!--类型过滤界面-->
        <el-dialog title="类型过滤" v-model="typeFilterFormVisible" :close-on-click-modal="false">
        </el-dialog>

        <!--标签过滤界面-->
        <el-dialog title="标签过滤" v-model="tagFilterFormVisible" :close-on-click-modal="false">
        </el-dialog>
...
<script>
    ...
    import {getUserListPage, removeUser, batchRemoveUser, editUser, addUser , seachUsingBasic,typedefs,deleteTag,addTag,getTerm,deleteTerm,addTerm,spliceTerm} from '../../api/api';
    export default {
        data() {
            return {
                startPageCount:10,
        ...
        methods: {
            ...
            searchTable:function () {
                this.page=1
				this.$router.push({name:'元数据管理',query:{tag:this.filters.tag,type:this.filters.type,query:this.filters.query,term:this.filters.term}})
