        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item label="类型">
                    <el-input v-model="filters.name" placeholder="选择类型"></el-input>
                </el-form-item>
                <el-tooltip content="类型属性过滤器">
                    <el-button type="primary"  icon="setting" size="small" class="pz" @click="typeFilter1" v-bind:disabled="disOne"></el-button>
                </el-tooltip>

                <el-form-item label="标签" v-if="advanced">
                    <el-select v-model="filters.tag" placeholder="选择标签">
                ...
                <el-form-item label="术语" v-if="advanced">
                    <el-select v-model="filters.term" placeholder="选择术语">
                        <el-option label="术语一" value="term1" ></el-option>
                        <el-option label="术语二" value="term2"></el-option>
                    </el-select>
                </el-form-item>

                <el-form-item label="文本" v-if="advanced">
                    <el-input v-model="filters.text" placeholder="输入文本"></el-input>
                </el-form-item>
    ...
    export default {
        ...
        watch:{
            'filters.name':function () {
                this.filters.name?this.disOne = false:this.disOne = true;
            },
            'filters.tag':function () {
                this.filters.tag?this.disTwo = false:this.disTwo = true;
            }
        },
        methods: {
            //性别显示转换
