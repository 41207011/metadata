        ...
        <el-row :gutter="20">
                ...
                <el-form>
                    <el-form-item style="margin-bottom: 0px;">
                        ...
                        <div style="float: right;margin-top: 2px;">
                            <el-button type="primary" v-if="false" size="small" title="创建术语表" @click="creatGlossaryModal()"><i class="fa fa-plus"></i>
                            </el-button>
            ...
            <el-col :span="19">
                ...
                <div v-if="chooseTerm&&!typeSwitch">
                    ...
                    <el-button type="primary" icon="edit" title='编辑业务' size="small" style="float: right;"
                    ...
                    <div v-if="chooseTerm.position!=='parent'">
                        <div  style="margin-bottom:12px" v-if="false">
                            <span>标签:</span>
                ...
                <div v-if="chooseTerm.position!=='parent'&&typeSwitch===false&&chooseTerm!==''">
                    <el-col :span="24" class="toolbar">
                        ...
                        <span  class=" pageShow" style="float: right;">如果您在下面的搜索结果中找不到该实体，那么您可以<a @click="createEntityModel">创建新的实体</a></span>
                    ...
                    <el-table :data="allUser" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                        ...
                        <el-table-column prop="name" label="名称" sortable :show-overflow-tooltip="true">
                            <template scope="scope">
                                <router-link :to="{ name: '数据详情', query: { guid: scope.row.guid ,name:scope.row.name}}">{{scope.row.name}}</router-link>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="type" label="类型" sortable>
                            <template scope="scope">
                                <router-link :to="{ name: '元数据管理', query: { type: scope.row.type }}">{{scope.row.type}}</router-link>
                            </template>
                        </el-table-column>
                ...
                <div v-if="chooseTerm2&&typeSwitch">
                    ...
                    <el-button type="primary" icon="edit" title='修改类别' size="small" style="float: right;" @click="editTagModal2"></el-button>
                    <div  style="margin-bottom:12px">
                        <span>短描述:</span>
                ...
                <!--创建实体-->
                <el-dialog title="创建实体" v-model="createEntityFormVisible" :close-on-click-modal="false">
                    <el-form    :model="createEntityForm" :rules="createEntityFormRules" ref="createEntityForm">

                            <el-row :gutter="50">
                                <el-col :span="18">
                                    <el-form-item  prop="typeName">
                                    <el-select v-model="createEntityForm.typeName" style="width: 100%" placeholder="--选择实体类型--">
                                        <el-option value="standard_03">standard_03</el-option>
                                    </el-select>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6" style="vertical-align: middle">
                                    <el-form-item>
                                        <font class="searchTip">必填</font>
                                        <el-switch v-model="typeSwitch2" on-text="" off-text="">

                                        </el-switch>
                                        <font class="searchTip">所有</font>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        <hr style="margin-top: 0px">

                        <el-form-item label="限定名" prop="attributes.qualifiedName" label-width="120px" :rules="createEntityFormRules.qualifiedName">
                            <el-input v-model="createEntityForm.attributes.qualifiedName"></el-input>
                        </el-form-item>

                        <el-form-item label="标准名"label-width="120px"  prop="attributes.name" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.name"></el-input>
                        </el-form-item>

                        <el-form-item label="字段信息" label-width="120px" prop="attributes.columns" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.columns"></el-input>
                        </el-form-item>
                        <el-form-item label="字段含义" label-width="120px"  prop="attributes.description" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.description"></el-input>
                        </el-form-item>
                        <el-form-item label="标准源表名" label-width="120px"  prop="attributes.sourceTableName" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.sourceTableName"></el-input>
                        </el-form-item>
                        <el-form-item label="标准源schema名" label-width="120px"  prop="attributes.sourceSchemaName" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.sourceSchemaName"></el-input>
                        </el-form-item>
                        <el-form-item label="标准源DB名" label-width="120px"  prop="attributes.sourceDBName" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.sourceDBName"></el-input>
                        </el-form-item>
                        <el-form-item label="标准目标表名" label-width="120px"  prop="attributes.targetTableName" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.targetTableName"></el-input>
                        </el-form-item>
                        <el-form-item label="英文编码" label-width="120px"  prop="attributes.columnEN" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.columnEN"></el-input>
                        </el-form-item>
                        <el-form-item label="中文名称" label-width="120px"  prop="attributes.nameCN" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.nameCN"></el-input>
                        </el-form-item>
                        <el-form-item label="字段类型" label-width="120px"  prop="attributes.dataType" :rules="createEntityFormRules.name">
                            <el-select v-model="createEntityForm.attributes.dataType" style="width: 100%" placeholder="请选择">
                                <el-option v-for="o in dataTypeList" :value="o" :label="o">

                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="是否为主键" label-width="120px"  prop="attributes.isPK->pk" :rules="createEntityFormRules.name">
                            <el-select v-model="createEntityForm.attributes['isPK->pk']" placeholder="请选择" style="width: 100%">
                        ...
                        <el-form-item label="是否为NULL" label-width="120px"  prop="attributes.nullable" :rules="createEntityFormRules.name">
                            <el-select v-model="createEntityForm.attributes.nullable" placeholder="请选择" style="width: 100%">
                                <el-option value="true" label="是">
                        ...
                        <el-form-item label="默认值" label-width="120px"  prop="attributes.defaultValue" :rules="createEntityFormRules.name">
                            <el-input v-model="createEntityForm.attributes.defaultValue"></el-input>
                        </el-form-item>
                        <div v-if="typeSwitch2">
                            <el-form-item label="关联约束" label-width="120px">
                                <el-input v-model="createEntityForm.attributes.constraints"></el-input>
                            </el-form-item>
                            <el-form-item label="值域码表" label-width="120px">
                                <el-input v-model="createEntityForm.attributes.columnValueTable"></el-input>
                            </el-form-item>
                            <el-form-item label="备注" label-width="120px">
                                <el-input v-model="createEntityForm.attributes.comment"></el-input>
                            </el-form-item>
                           <p style="    font-weight: bold;font-style: italic;">标准来源</p>
                            <hr>
                            <el-form-item label="id" label-width="120px">
                                <el-input v-model="createEntityForm.attributes.interfaceSource.id"></el-input>
                            </el-form-item>
                            <el-form-item label="名称" label-width="120px">
                                <el-input v-model="createEntityForm.attributes.interfaceSource.name"></el-input>
                            </el-form-item>
                            <el-form-item label="url" label-width="120px">
                                <el-input v-model="createEntityForm.attributes.interfaceSource.url"></el-input>
                            </el-form-item>
                        </div>
    ...
    export default {
        ...
        this.$refs['createEntityForm'].validate((valid) => {
            if (valid) {
                this.$confirm('确认提交吗？', '提示', {}).then(() => {
                    this.addLoading = true;
                    let params = {content:{entity:this.createEntityForm},id:this.chooseTerm.guid}
