<template>
    <section>
        <el-row :gutter="20">
            <el-col :span="5" id="leftDiv">
                <el-form>
                    <el-form-item style="margin-bottom: 0px;">
                        <div style="float: right;margin-top: 2px;">
                            <el-button type="primary" size="small" title="创建目录" @click="creatGlossaryModal(0)"><i class="fa fa-plus"></i></el-button>
                                <el-button type="primary" size="small" title="刷新" ><i class="fa fa-refresh"></i></el-button>
                        </div>
                    </el-form-item>
                </el-form>
                <div v-show="typeSwitch">
                    <el-input placeholder="搜索目录,分类" v-model="searchWord2"
            ...
            <el-col :span="19" v-show="standardNameId">
                <!--工具条-->
                <div >
                    <el-col :span="24" class="toolbar">
                        <span class="pageShow">显示<u> {{startPageCount}}条数据 </u> 从 <font> {{startPage}} </font>-<font> {{endPage}} </font></span>
                        <span  class=" pageShow" style="float: right;">如果您在下面的搜索结果中找不到该标准表，那么您可以<a @click="createEntityModel">创建新的标准表</a></span>
                    ...
                    <el-table :data="allUser" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                        ...
                        <el-table-column type="expand">
                            <template scope="props">
                                <el-table  :data=" props.row.columns"  v-show="props.row.columns.length>0" style="padding: 0px 0px">
                                        <el-table-column label="列名"  prop="standardColumnsName" min-width="150px">
                                            <template scope="scope">
                                                <el-input v-model="scope.row.standardColumnsName"></el-input>

                                            </template>
                                        </el-table-column>
                                        <el-table-column label="中文名称" prop="namecn" min-width="150px">
                                            <template scope="scope">
                                        ...
                                        <el-table-column label="字段类型" prop="datatype" min-width="150px">
                                            <template scope="scope">
                                                <el-input v-model="scope.row.datatype"></el-input>

                                            </template>
                                        </el-table-column>
                                        <el-table-column label="值域码表" prop="columnvauletable" min-width="150px">
                                            <template scope="scope">
                                                <el-input v-model="scope.row.columnvauletable"></el-input>

                                            </template>
                                        </el-table-column>
                                        <el-table-column label="备注" prop="comment" min-width="150px">
                                            <template scope="scope">
                             ...
                             <!--       <el-table-column label="描述" prop="description" min-width="150px">
                                    ...
                                    <el-table-column label="英文编码" prop="columnen" min-width="150px">
                                        <template scope="scope">
                                            <el-input v-model="scope.row.columnen"></el-input>

                                        </template>
                                    </el-table-column>
                                    <el-table-column label="是否主键" prop="ispk" min-width="150px">
                                        <template scope="scope">
                                            <el-input v-model="scope.row.ispk"></el-input>

                                        </template>
                                    </el-table-column>
                                    <el-table-column label="是否为null" prop="nullable" min-width="150px">
                                        <template scope="scope">
                                            <el-input v-model="scope.row.nullable"></el-input>

                                        </template>
                                    </el-table-column>
                                    <el-table-column label="默认值" prop="defaultvalue" min-width="150px">
                                        <template scope="scope">
                                            <el-input v-model="scope.row.defaultvalue"></el-input>

                                        </template>
                                    </el-table-column>
                                    <el-table-column label="关联约束" prop="constraints" min-width="150px">
                                        <template scope="scope">
                                            <el-input v-model="scope.row.constraints"></el-input>

                                        </template>
                                    </el-table-column>
                                        <el-table-column label="标准ID" min-width="150px">
                                            <template scope="scope">
                                                <el-input v-model="scope.row.interfacesourceid"></el-input>

                                            </template>
                                        </el-table-column>
                                        <el-table-column label="标准ID名" min-width="150px">
                                            <template scope="scope">
                                                <el-input v-model="scope.row.interfacesourcename"></el-input>

                                            </template>
                                        </el-table-column>
                                        <el-table-column label="标准URL" min-width="150px">
                                            <template scope="scope">
                                                <el-input v-model="scope.row.interfacesourceurl"></el-input>

                                            </template>
                                        </el-table-column>-->
                                        <el-table-column label="操作" min-width="120px">
                                            <template scope="scope">
                                                <el-button size="mini" type="warning" title="保存修改" @click="saveNewRow(props.$index,scope.$index)"><i class="fa fa-save"></i></el-button>
                                                <el-button size="mini" type="danger" title="删除" style="margin-left: 2px;" @click="removeNewRow(props.$index,scope.$index)"><i class="fa fa-trash"></i></el-button>
                                                <el-button size="mini" type="primary" title="添加新列"  style="margin-left: 2px;" @click="addNewRow(props.$index,scope.$index)"><i class="fa fa-plus"></i></el-button>
                                            </template>
                                        </el-table-column>
                                    </el-table>

                                <span  class="el-table__empty-text"  v-show="props.row.columns.length===0">暂无列数据，您可以<a @click="addNewRow2(props.$index)">创建新的列</a></span>
                                <!--<el-col v-for="one in props.row.columns">
                                    <el-form-item label="列名">
                                        <el-input v-model="one.standardColumnsName"></el-input>
                                    </el-form-item>
                                    <el-form-item label="英文编码">
                                        <span>{{ one.columnen }}</span>
                                    </el-form-item>
                                    <el-form-item label="中文名称">
                                        <span>{{ one.namecn }}</span>
                                    </el-form-item>
                                    <el-form-item label="描述">
                                        <span>{{ one.description }}</span>
                                    </el-form-item>
                                    <el-form-item label="字段类型">
                                        <span>{{ one.datatype }}</span>
                                    </el-form-item>
                                    <el-form-item label="是否主键">
                                        <span>{{ one.ispk }}</span>
                                    </el-form-item>
                                    <el-form-item label="是否为null">
                                        <span>{{ one.nullable }}</span>
                                    </el-form-item>
                                    <el-form-item label="默认值">
                                        <span>{{ one.defaultvalue }}</span>
                                    </el-form-item>
                                    <el-form-item label="关联约束">
                                        <span>{{ one.constraints }}</span>
                                    </el-form-item>
                                    <el-form-item label="值域码表">
                                        <span>{{ one.columnvauletable }}</span>
                                    </el-form-item>
                                    <el-form-item label="备注">
                                        <span>{{ one.comment }}</span>
                                    </el-form-item>
                                    <el-form-item label="标准ID">
                                        <span>{{ one.interfacesourceid }}</span>
                                    </el-form-item>
                                    <el-form-item label="标准ID名">
                                        <span>{{ one.interfacesourcename }}</span>
                                    </el-form-item>
                                    <el-form-item label="标准URL">
                                        <span>{{ one.interfacesourceurl }}</span>
                                    </el-form-item>
                                </el-col>-->

                            </template>
                        </el-table-column>
                        <el-table-column prop="standardTableName" label="标准名称"  :show-overflow-tooltip="true">
                         <!--   <template scope="scope">
                                {{scope.row.standardTableName}}
                                &lt;!&ndash;<router-link :to="{ name: '数据详情', query: { guid: scope.row.guid ,name:scope.row.name}}">{{scope.row.name}}</router-link>&ndash;&gt;
                            </template>-->
                        </el-table-column>
                        ...
                        <el-table-column prop="createdate" label="创建时间"  :show-overflow-tooltip="true">
                            <!--<template scope="scope">
                                ...
                                &lt;!&ndash;<router-link :to="{ name: '元数据管理', query: { type: scope.row.type }}">{{scope.row.type}}</router-link>&ndash;&gt;
                            </template>-->
                        </el-table-column>
                        <el-table-column prop="updatadate" label="更新时间"  :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="comment" label="注释"  :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="status" label="状态"  sortable  :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="maintainertype" label="维护类型">
                        </el-table-column>
                        <el-table-column  label="操作" >
                            <template scope="scope">
                                <el-button size="mini" title="编辑" type="primary" @click="editModelShow(scope.$index)"><i class="fa fa-edit"></i></el-button>
                                <el-button size="mini" title="删除" type="danger" @click="remove2(scope.$index)"><i class="fa fa-trash"></i></el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    ...
                    <!--工具条-->
                    <el-col :span="24" class="toolbar">
                        <el-pagination layout="sizes,prev, pager, next, jumper" @current-change="ggetUser()" @size-change="handleSizeChange" :page-size="startPageCount" :page-sizes="[10, 20, 50, 100]" style="float:right;" :total="total" >
                        </el-pagination>
                    </el-col>
            ...
            <!--编辑标签界面-->
            <el-dialog :title="title" v-model="editTagFormVisible" :close-on-click-modal="false">
            ...
            <!--创建术语表-->
            <el-dialog title="创建目录" v-model="createGlossaryFormVisible" :close-on-click-modal="false">
                <el-form  label-width="70px"  :model="createGlossaryForm" :rules="createGlossaryFormRules" ref="createGlossaryForm">
                    <el-form-item label="名称"  prop="standardName">
                        <el-input v-model="createGlossaryForm.standardName" ></el-input>
                    </el-form-item>
            ...
            <!--为术语表添加项目-->
            <el-dialog title="创建项目" v-model="createProjectFormVisible" :close-on-click-modal="false">
            ...
            <!--创建类别-->
            <el-dialog title="修改目录" v-model="createCagFormVisible" :close-on-click-modal="false">
                <el-form  label-width="70px"  :model="createCagForm" :rules="createCagFormRules" ref="createCagForm">
                    <el-form-item label="名称"  prop="standardName">
                        <el-input v-model="createCagForm.standardName" ></el-input>
                    </el-form-item>
                    <!--     <el-form-item label="短描述" prop="shortDescription">
            ...
            <!--创建实体-->
            <el-dialog title="创建标准表" v-model="createEntityFormVisible" :close-on-click-modal="false">
                <el-form    :model="createEntityForm" :rules="createEntityFormRules" ref="createEntityForm">

                    <el-form-item label="表名" prop="standardTableName" label-width="120px" :rules="createEntityFormRules.name">
                        <el-input v-model="createEntityForm.standardTableName"></el-input>
                    </el-form-item>
                    <el-form-item label="状态" label-width="120px"  prop="status" :rules="createEntityFormRules.int">
                        <el-input v-model="createEntityForm.status"></el-input>
                    </el-form-item>
                    <el-form-item label="维护类型" label-width="120px"  prop="maintainertype" :rules="createEntityFormRules.name">
                        <el-input v-model="createEntityForm.maintainertype"></el-input>
                    </el-form-item>
                    <el-form-item label="备注" label-width="120px"  prop="comment">
                        <el-input v-model="createEntityForm.comment"></el-input>
                    </el-form-item>
                    <el-form-item label="描述"label-width="120px"  prop="description">
                        <el-input v-model="createEntityForm.description"></el-input>
                    </el-form-item>

                </el-form>
                <div slot="footer" class="dialog-footer">
                    <el-button @click.native="createEntityFormVisible = false">取消</el-button>
                    <el-button type="primary" @click.native="createEntity" :loading="addLoading">提交</el-button>
                </div>
            </el-dialog>
        </el-row>
    </section>
...
<script>
    import {remove3,saveorupdate,remove2,saveOrUpdate2,OrUpdate,saveOrUpdate,remove,getSTable,getTree,createEntity,deleteCategory,getCategory,typedefs,seachUsingBasic,deleteTag,deleteTerm,addTag,getTerm,spliceTerm2,addTerm,addAttributes,createTag,DeleteTag,getTermDetails,putTerm,getRelation,putCategory,putGlossary,createGlossary,deleteGlossary,postTerm,deleteTerm_,creatCategory,demo} from '../../api/api'
    export default {
        data() {
            return {
                standardId:'',
                ...
                upParentId:'',
                chooseParentId:'',
                dataTypeList:['STRING','ENTITY','BOOLEAN','LONG','DATE','DOUBLE','INTEGER'],
                loadingTree:false,
                typeSwitch2:false,
                startPageCount:10,
                createCagType:'',
                ...
                createGlossaryFormRules:{
                    standardName:{required:true,message:'请输入目录名称'}
                },
                //创建术语表
                //创建实体
                ...
                createEntityFormRules:{
                    typeName:{required:true,message:'请选择实体类型'},
                    qualifiedName:{required:true,message:'该项不能为空'},
                    name:{required:true,message:'该项不能为空'},
                    int:[{required:true,message:'该项不能为空'}]
                },
                //创建实体
                //为术语表添加项目
                ...
                createCagFormRules:{
                    standardName:{required:true,message:'请输入术语表名称'}
                },
                //创建类别
                title:'修改项目',
                ChooseCate:'',
        ...
        methods: {
            ...
            saveNewRow(index1,index2){
             let params =  this.allUser[index1].columns[index2]
            ...
            removeNewRow(index1,index2){
                let id = this.allUser[index1].columns[index2].id
                remove3({id:id}).then(res=>{
                    let code = res.data.code
                    if(code===1){
                        this.$message({
                            message: '删除列失败',
                        ...
                        this.allUser[index1].columns.splice(index2,1)
                    }
            ...
            addNewRow(index1,index2){
                saveorupdate({standardTableId:this.allUser[index1].id}).then(res=>{
                 this.allUser[index1].columns.push({id:res.data.id})
                }).catch(err=>{
            ...
            createEntityModel(){
                this.createEntityFormVisible = true;
                this.standardId = ''
                this.createEntityForm ={}
            },
            editModelShow(index){
                this.createEntityFormVisible = true;
                this.createEntityForm = Object.assign({},this.allUser[index])
            },
                ...
                if (node.level >1) {
                    getRelation(node.data.categoryGuid).then(res=>{
                        ...
                        if(res.data.children){
                            for(let value of res.data.children){
                                let json={};
                ...
                this.$confirm('是否删除该术语?','提示',{
                    ...
                    if(this.typeSwitch===false){
                        ...
                        putCategory(params).then(res=>{
                            ...
                            this.chooseTerm2=res.data
                            demo(res.data.guid).then(res=>{
                            ...
                            if(this.typeSwitch===false){
                                ...
                                if(this.chooseTerm.position==='parent'){
                                    putGlossary(params).then((res) => {
                                        ...
                                        this.chooseTerm  = Object.assign(this.chooseTerm,res.data)
                                        this.getTerm();
                                    }).catch(err=>{
                                        this.$message({
                                            message: '修改项目失败',
                                ...
                                if(this.typeSwitch===true){
                                    ...
                                    if(this.chooseTerm2.position==='parent'){
                                        putGlossary(params).then((res) => {
                                            ...
                                            this.editTagFormVisible = false;
                                            this.chooseTerm2  = Object.assign(this.chooseTerm2,res.data)
                                        }).catch(err=>{
                                            this.$message({
                                                message: '修改词汇表失败',
                                                type: 'error'
            ...
            createGlossary: function () {
                ...
                this.$refs['createGlossaryForm'].validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            this.addLoading = true;
                            let params = Object.assign({parentId:this.chooseParentId},this.createGlossaryForm)
                            saveOrUpdate(params).then((res) => {
                                this.addLoading = false;
                                this.$message({
                                    message: '创建目录成功',
            ...
            createCag_: function () {
                ...
                this.$refs['createCagForm'].validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            this.addLoading = true;
                            let params = {id:this.upId,parentId:this.upParentId,standardName:this.createCagForm.standardName}
                            OrUpdate(params).then((res) => {
                                this.addLoading = false;
                                //NProgress.done();
                                this.$message({
                                    message: '修改目录成功',
            ...
            createEntity: function () {
             var this_ = this
              this.$refs['createEntityForm'].validate((valid) => {
            if (valid) {
                this.$confirm('确认提交吗？', '提示', {}).then(() => {
                    this.addLoading = true;
                    let params
                    if(this.standardId){
                        params = Object.assign({id:this.standardId,standardNameId:this.standardNameId},this.createEntityForm)
                    }
                    else{
                        params = Object.assign({standardNameId:this.standardNameId},this.createEntityForm)
                    }
                    saveOrUpdate2(params).then((res) => {
                        ...
                        this.createEntityFormVisible = false;
                        let params2 = {standardNameId:this.standardNameId,offset:(this.page-1)*this.startPageCount,limit:this.startPageCount}
                        getSTable(params2).then(res=>{
                            this.allUser = res.data.rows
                            this.total = res.data.total
                            this.startPage = (this.page-1)*this.startPageCount
                            this.endPage = (this.page)*this.startPageCount
            ...
            //创建术语表模态框显示
            creatGlossaryModal: function (val) {
                this.createGlossaryFormVisible = true;
                this.createGlossaryForm = {standardName:''}
                this.chooseParentId = val
            },
            //创建术语表项目模态框显示
            ...
            //创建类别显示
            createCag(id,parentId,text){
                this.upId = id
                this.upParentId = parentId
                this.createCagFormVisible = true;
                this.createCagForm = {standardName:text}
            },
            //删除术语表
            ...
            remove2:function (index) {
                this.$confirm('是否删除该标准表?','提示',{
                    confirmButtonText:'确定',
                    cancelButtonText:'取消',
                    type:'warning'}).then(() => {
                    remove2({id:this.allUser[index].id}).then(res=>{
                        let code = res.data.code
                        if(code===1){
                            this.$message({
                                message: '操作失败',
                            ...
                            let params = {standardNameId:this.standardNameId,offset:(this.page-1)*this.startPageCount,limit:this.startPageCount}
                            getSTable(params).then(res=>{
                                this.allUser = res.data.rows
                                this.total = res.data.total
                                this.startPage = (this.page-1)*this.startPageCount
                                this.endPage = (this.page)*this.startPageCount
            ...
            goBasic:function(tag){
                this.$router.push({name:"元数据管理",query:{tag:tag}})
            },
            //标签获取
            getTag:function () {
                var this_ = this;
            ...
            renderContent2(h, { node, data, store }) {
                ...
                width="150"
                trigger="hover">
                    <div class='popoverDiv' style='font-size: 14px !important;color: #666 !important;cursor:pointer'  on-click={ ()=>this.creatGlossaryModal(data.id)}><i class="fa fa-plus fa-fw" style="margin-left:20px;margin-right:10px"></i>创建子目录</div>
                <div  class='popoverDiv' style='font-size: 14px !important;color: #666 !important;cursor:pointer'  on-click={ ()=>this.createCag(data.id,data.parentId,data.text)}><i class="fa fa-edit fa-fw" style="margin-left:20px;margin-right:10px"></i>修改目录</div>
                <div class='popoverDiv' style='font-size: 14px !important;color: #666 !important;cursor:pointer' on-click={()=>this.deleteCag_(data.id)}><i class="fa fa-trash fa-fw" style="margin-left:20px;margin-right:10px"></i>删除目录</div>
                <i class='fa fa-ellipsis-h' slot="reference" ></i>
                    </el-popover>
            ...
            nodeClick(data,node){
                ...
                if(data.position==='children'){
                    this.getTermDetails_()
                    this.$router.push({name:'标准维护',query:{termId:data.id}})
                }
                    ...
                    this.allUser = [];
                    console.log(this.chooseTerm)
                    this.$router.push({name:'标准维护',query:{}})
                }
                $('.el-tree-node__content').removeClass('nnn')
        ...
        /*    if(this.$route.query.termId){
                this.ChooseNode = this.$route.query.termId
                this.getTermDetails_()
                $("#"+this.$route.query.termId).parent().parent('.el-tree-node').parent('.el-tree-node__children').css('display','block')
                $("#"+this.$route.query.termId).parent('.el-tree-node__content').addClass('nnn')
                $("#"+this.$route.query.termId).parent().parent('.el-tree-node').parent().parent('.el-tree-node').addClass('is-expanded')
                $("#"+this.$route.query.termId).parent().parent('.el-tree-node').parent().parent('.el-tree-node').children('.el-tree-node__content').children('.el-tree-node__expand-icon').attr('class','el-tree-node__expand-icon expanded')
            }*/
