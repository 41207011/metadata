<template>
    <section>
        <el-row :gutter="20">
                ...
                <el-form>
                    <el-form-item style="margin-bottom: 0px;">
                        <div style="float: right;margin-top: 2px;">
                            <el-button type="primary" size="small" title="创建术语表" @click="creatGlossaryModal()"><i class="fa fa-plus"></i></el-button>
            ...
            <el-col :span="19" v-show="standardNameId">
                ...
                <div >
                    <el-col :span="24" class="toolbar">
                        ...
                        <span  class=" pageShow" style="float: right;">如果您在下面的搜索结果中找不到该标准表，那么您可以<a @click="createEntityModel">创建新的数据源</a></span>
                    ...
                    <el-table :data="allUser" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                        ...
                        <el-table-column prop="status" label="接口状态" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="maintainerType" label="来源/维护类型" :show-overflow-tooltip="true">
                        </el-table-column>
                        <!--<el-table-column prop="type" label="接口类型" :show-overflow-tooltip="true">
                        </el-table-column>-->
                        <el-table-column prop="sourceType" label="源类型" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="description" label="描述" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="createDate" label="创建时间" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="updateDate" label="修改时间" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="survivalState" label="存活状态" :show-overflow-tooltip="true">
                        </el-table-column>
                       <!-- <el-table-column prop="accessTestTime" label="访问测试时间" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="whetherToGenerate" label="是否生成" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="approvalStatus" label="审核状态" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="resultType" label="返回数据格式" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="url" label="访问url" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="params" label="访问参数" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="serviceName" label="服务名称" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="username" label="用户名" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="password" label="用户密码" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="properties" label="属性" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="columns" label="列信息" :show-overflow-tooltip="true">
                        </el-table-column>-->
                        <el-table-column  label="操作" min-width="100px" >
                            <template scope="scope">
                                <el-button size="mini" title="编辑" type="primary" @click="editModelShow(scope.$index)"><i class="fa fa-edit"></i></el-button>
                                <el-button size="mini" title="删除" type="danger" @click="remove2(scope.$index)" style="margin-left: 2px"><i class="fa fa-trash"></i></el-button>
                            </template>
                        </el-table-column>
                    </el-table>
            ...
            <!--添加术语界面-->
            <el-dialog title="将类别指定为术语" v-model="addPropertyFormVisible" :close-on-click-modal="false">
            ...
            <!--添加术语界面2-->
            <el-dialog title="将术语分配给类别" v-model="addTermToCagFormVisible" :close-on-click-modal="false">
            ...
            <!--创建术语表-->
            <el-dialog title="创建术语表" v-model="createGlossaryFormVisible" :close-on-click-modal="false">
            ...
            <!--创建类别-->
            <el-dialog title="创建类别" v-model="createCagFormVisible" :close-on-click-modal="false">
            ...
            <!--创建实体-->
            <el-dialog title="创建数据源" v-model="createEntityFormVisible" :close-on-click-modal="false">
                <el-form    :model="createEntityForm" :rules="createEntityFormRules" ref="createEntityForm">

                    <el-form-item label="接口名称" prop="name" label-width="120px" :rules="createEntityFormRules.name">
                        <el-input v-model="createEntityForm.name"></el-input>
                    </el-form-item>
                    <el-form-item label="接口状态" label-width="120px"  prop="status">
                        <el-input v-model="createEntityForm.status"></el-input>
                    </el-form-item>
                    <el-form-item label="来源/维护类型" label-width="120px"  prop="maintainerType" >
                        <el-input v-model="createEntityForm.maintainerType"></el-input>
                    </el-form-item>
                    <el-form-item label="接口类型" label-width="120px"  prop="type" >
                        <el-input v-model="createEntityForm.type"></el-input>
                    </el-form-item>
                    <el-form-item label="接入类型" label-width="120px"  prop="sourceType">
                        <el-input v-model="createEntityForm.sourceType"></el-input>
                    </el-form-item>
                    <el-form-item label="接口描述" label-width="120px"  prop="description">
                        <el-input v-model="createEntityForm.description"></el-input>
                    </el-form-item>
                    <el-form-item label="存活状态" label-width="120px"  prop="survivalState">
                        <el-input v-model="createEntityForm.survivalState"></el-input>
                    </el-form-item>
                    <el-form-item label="访问测试时间" label-width="120px"  prop="accessTestTime">
                        <el-input v-model="createEntityForm.accessTestTime"></el-input>
                    </el-form-item>
                    <el-form-item label="是否生成" label-width="120px"  prop="whetherToGenerate">
                        <el-input v-model="createEntityForm.whetherToGenerate"></el-input>
                    </el-form-item>
                    <el-form-item label="审核状态" label-width="120px"  prop="approvalStatus">
                        <el-input v-model="createEntityForm.approvalStatus"></el-input>
                    </el-form-item>
                    <el-form-item label="返回数据格式" label-width="120px"  prop="resulttype">
                        <el-input v-model="createEntityForm.resulttype"></el-input>
                    </el-form-item>
                    <el-form-item label="访问url" label-width="120px"  prop="url">
                        <el-input v-model="createEntityForm.url"></el-input>
                    </el-form-item>
                    <el-form-item label="访问参数" label-width="120px"  prop="params">
                        <el-input v-model="createEntityForm.params"></el-input>
                    </el-form-item>
                    <el-form-item label="服务名称" label-width="120px"  prop="servicename">
                        <el-input v-model="createEntityForm.servicename"></el-input>
                    </el-form-item>
                    <el-form-item label="用户名" label-width="120px"  prop="username">
                        <el-input v-model="createEntityForm.username"></el-input>
                    </el-form-item>
                    <el-form-item label="密码" label-width="120px"  prop="password">
                        <el-input v-model="createEntityForm.password"></el-input>
                    </el-form-item>
                    <el-form-item label="属性" label-width="120px"  prop="properties">
                        <el-input v-model="createEntityForm.properties"></el-input>
                    </el-form-item>
                    <el-form-item label="列信息" label-width="120px"  prop="columns">
                        <el-input v-model="createEntityForm.columns"></el-input>
                    </el-form-item>

                    <!--   <el-form-item label="状态"label-width="120px"  prop="statusflag">
                           <el-input v-model="createEntityForm.statusflag"></el-input>
                       </el-form-item>-->
...
<script>
    import {datasourceList,datasourceSaveorupdate,datasourceRemove,codingRuleRemove,codingRuleSaveOrUpdate,codingRuleList,remove2,saveOrUpdate2,OrUpdate,saveOrUpdate,remove,getSTable,getTree,createEntity,deleteCategory,getCategory,typedefs,seachUsingBasic,deleteTag,deleteTerm,addTag,getTerm,spliceTerm,spliceTerm2,addTerm,addAttributes,createTag,DeleteTag,getTermDetails,putTerm,getRelation,putCategory,putGlossary,createGlossary,deleteGlossary,postTerm,deleteTerm_,creatCategory,demo} from '../../api/api'
    export default {
        data() {
            return {
        ...
        methods: {
            ...
            if (valid) {
                this.$confirm('确认提交吗？', '提示', {}).then(() => {
                    ...
                    let params
                    if(this.standardId){
                        params = Object.assign({id:this.standardId,parentid:this.standardNameId},this.createEntityForm)
                    }
                    else{
                        params = Object.assign({parentid:this.standardNameId},this.createEntityForm)
                    }
                    datasourceSaveorupdate(params).then((res) => {
                        this.addLoading = false;
                        //NProgress.done();
                        ...
                        if(code===1){
                            ...
                            let params2 = {parentid :this.standardNameId,offset:(this.page-1)*this.startPageCount,limit:this.startPageCount}
                            datasourceList(params2).then(res=>{
            ...
            remove2:function (index) {
                this.$confirm('是否删除该数据源?','提示',{
                    ...
                    cancelButtonText:'取消',
                    type:'warning'}).then(() => {
                    datasourceRemove({id:this.allUser[index].id}).then(res=>{
                        let code = res.data.code
                        if(code===1){
                            this.$message({
                                message: '删除失败',
            ...
            ggetUser(){
                let params = {parentid :this.standardNameId,offset:(this.page-1)*this.startPageCount,limit:this.startPageCount}
            ...
            nodeClick3(data,node,tree){
                console.log(data)
                this.standardNameId = data.categoryGuid
                this.ggetUser()
                let arr = this.data3
                console.log(data)
