    ...
    <section>
        <el-row :gutter="20">
            ...
            <el-col :span="19">
                ...
                <el-button type="primary" icon="edit" title='编辑标签' size="small" style="float: right;"
                ...
                <!--添加属性界面-->
                <el-dialog title="添加属性" v-model="addPropertyFormVisible" :close-on-click-modal="false">
                    <el-form :inline="false" :model="addPropertyForm"  ref="addProperty">
                        <el-form-item>
                            ...
                            <el-row :gutter="10" v-for="(dataOne,index) in addPropertyForm.data">
                                ...
                                <el-col :span="2">
                                    <el-button type="danger" icon="delete" @click="deleteProperty(index)"></el-button>
                                </el-col>
                            </el-row>
                ...
                <el-dialog title="编辑标签" v-model="editTagFormVisible" :close-on-click-modal="false">
                    <el-form :inline="false" :model="editTagForm" label-width="50px" ref="editTagForm" :rules="editTagFormRules">
                ...
                <!--添加标签界面2-->
                <el-dialog title="添加标签" v-model="addTagFormVisible2" :close-on-click-modal="false">
                    <el-form   :model="addTagForm2" :rules="addTagFormRules2" ref="addTagForm2">
                        ...
                        <el-form-item>
                            ...
                            <el-row :gutter="10" v-for="(dataOne,index) in addTagForm2.data">
                                ...
                                <el-col :span="2">
                                    <el-button type="danger" icon="delete" @click="deleteProperty2(index)"></el-button>
                                </el-col>
                            </el-row>
...
<script>
    import {typedefs,seachUsingBasic,deleteTag,deleteTerm,addTag,getTerm,addTerm,addAttributes,createTag,DeleteTag,spliceTerm} from '../../api/api'
    export default {
        data() {
            return {
                startPageCount:10,
                    ...
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            addAttributes(params_).then((res) => {
                                ...
                                this.chooseTag.description = res.data.classificationDefs[0].description
                            }).catch(err=>{
                                this.$message({
                                    message: '接口报错',
                                    type: 'error'
